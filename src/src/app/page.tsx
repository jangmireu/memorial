  ...
  return (
      <div className="flex flex-col">
        ...
        <section className="relative w-screen h-screen bg-stone-600">
          <div className="w-screen h-screen flex flex-col items-center justify-center bg-gray-200">
            <Image
              ...
              objectFit="contain"
            />
            <h1 className="text-3xl font-bold text-black mt-10 text-center leading-relaxed ${styles.customTitle}">
        ...
        <section className="p-10 text-center w-full bg-white">
          <p className="text-lg ${styles.customTitle}">추모 국화로 함께 애도해 주세요</p>
          <h2 className="text-4xl font-bold mt-5 ${styles.customTitle}">703,055명이 함께 하고 있습니다</h2>
